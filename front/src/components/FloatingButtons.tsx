...
import {
  ...
  FaComment,
  FaTimes,
  FaLine // تم إضافة أيقونة لاين هنا
} from "react-icons/fa";
  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed z-50 bottom-[15vh] border-2 border-brand-gold bg-brand-red text-white p-3 rounded-full cursor-pointer shadow-2xl transition-all duration-500 hover:scale-110 hover:bg-red-900 animate-bounce ${showUp ? "left-5 opacity-100" : "-left-16 opacity-0"
          }`}
      >
      ...
      <div className="fixed z-50 bottom-[8vh] right-4 flex flex-col-reverse items-center gap-3">
        ...
        {/* الأزرار الفرعية */}
        <div
          className={`flex flex-col gap-3 transition-all duration-500 origin-bottom ${isSocialOpen
        ...
        >
          ...
          {/* زر لاين (Line) - تمت إضافته هنا */}
          <a
            href="https://line.me/ti/p/IuAqVt59QV"
            target="_blank"
            rel="noreferrer"
            aria-label="لاين"
            className="p-3.5 rounded-full bg-brand-red border-2 border-brand-gold text-white shadow-lg cursor-pointer transition-all duration-300 hover:scale-110 hover:bg-red-900 flex items-center justify-center"
          ...
          <a
            href="mailto:contact@sawagroup.jp"
